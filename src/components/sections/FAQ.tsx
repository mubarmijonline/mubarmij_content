...
const QUESTIONS_AR = [
  ...
  { q: "بتستخدموا أنهي تكنولوجيات؟", a: "Next.js, Node.js, Postgres, React Native, Flutter, AWS, Cloudflare، وأدوات أتمتة زي n8n وMake.com." },
...
const QUESTIONS_EN = [
  ...
  { q: "What technologies do you use?", a: "Next.js, Node.js, Postgres, React Native, Flutter, AWS, Cloudflare, plus automation tools like n8n and Make.com." },

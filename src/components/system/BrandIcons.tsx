...
/**
 * The green circle mark — what the floating action button uses.
 *
 * Reuses the exact glyph from WhatsAppIcon, scaled and centred inside the
 * circle, rather than a second hand-drawn handset. One path, one source of
 * truth, and it can't drift from the inline icon.
 */
